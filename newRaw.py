...
if __name__ == '__main__':
    gestname = raw_input("Gesture name:\n")
    if not os.path.exists("data"):
        os.makedirs("data")
    fopen = open("data/"+gestname+".txt",'a')
    fopen.write("typ,cls,cmd,label\n")
    try:
        import pygame
